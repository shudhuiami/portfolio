<template>
  <div class="page-content-wrapper">
    <div class="section-home" :style="{'background-image': 'url('+media.homeCoverBg+')'}">
      <h1 class="glass">AHMED <br> ZOBAYER</h1>
    </div>
      ...
      <div class="inner-container">
        ...
        <div class="about-me-wrapper">
          <div class="row justify-content-center align-items-center">
            <div class="col-md-5">
              <img class="about-img img-fluid wow-none fadeInUp" data-wow-none-duration="1s" src="https://shudhuiami.github.io/resources/media/covers/cover_1.jpg" alt="About Picture">
            </div>
            <div class="col-md-7">
                ...
                <div class="about-desc-more text-left mt-5">
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="about-desc-info">
                        <b>Email :</b>
                        <a class="text-underline" href="mailto:gtomdesign@gmail.com">zobayer.me@gmail.com</a>
                      </div>
                    </div>
